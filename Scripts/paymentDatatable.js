    ...
    $("#cbtn-selectors1").DataTable({
        ...
        "columns": [
            ...
            },
            {
                "render": function (data, type, full)
                {
                    return "<a href='Payment/Edit/" + full.paymentID + "' class='btn btn-danger btn-mini btn-outline-primary'><i class='icofont icofont-ui-close'></i></a>";        
                }
            },           
        ]
    });
